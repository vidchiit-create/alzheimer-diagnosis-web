...
# ==========================================
# 2. LOAD MÔ HÌNH VÀ TEMPLATE (CACHE)
# ==========================================
@st.cache_resource
def load_system():
    # Tải checkpoint từ Hugging Face nếu chưa có
    if not os.path.exists(CHECKPOINT_PATH):
        # THAY BẰNG LINK DIRECT DOWNLOAD HUGGING FACE CỦA BẠN
        ...
        with st.spinner("Đang tải trọng số mô hình từ Hugging Face..."):
            ...
            if response.status_code == 200:
                ...
                st.error("Không thể tải file checkpoint từ server.")
